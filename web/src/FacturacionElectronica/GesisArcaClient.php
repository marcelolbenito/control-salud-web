...
/**
 * Cliente HTTP para Gesis factura electrónica (mismo patrón que instituto-web).
 */
final class GesisArcaClient
{
    ...
    /**
     * @param array<string, mixed> $gesisConfig
     */
    ...
    public function crearProximoComprobante(array $voucherData, bool $production = false): array
    {
        ...
        return $this->requestJson('POST', '/api/v1/arca/crear-proximo-comprobante', $payload, true);
    }
    ...
    private function login(): void
    {
        if (!$this->isConfigured()) {
            throw new \RuntimeException(
                'Gesis no configurado: complete Facturación electrónica → Parámetros.'
            );
        }
     ...
     */
    public static function extraerError(array $decoded): string
    {
