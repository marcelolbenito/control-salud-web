...
final class CatalogosController
{
    ...
    private static function catalogoUxMeta(string $tabla): array
    {
        $map = [
            ...
            'lista_practicas' => ['categoria' => 'Ordenes', 'descripcion' => 'Códigos y nombres del nomenclador de prácticas. Los importes por obra social están en Aranceles (precios OS).'],
